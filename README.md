...
* Dialysis session and claims tracking
* Admin portal for records management
* Responsive and user-friendly dashboard
* PDF form generation support
...
## Installation
### Enter the following commands in your terminal to install the dependencies and start the development server.
```bash
git clone <repository-url>
cd PhilHealth_DialysisFormSystem/dialysis
npm install
npm run dev
```
